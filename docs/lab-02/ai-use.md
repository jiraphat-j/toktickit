...
1. **การควบคุมด้วย Spec-Driven & Test-Driven Development (TDD):**
   หากปล่อยให้ AI เขียนโค้ดโดยไม่มีกรอบที่ชัดเจน AI มักจะสร้างโซลูชันที่ครอบคลุมเฉพาะ Happy Path แต่ตกหล่น Edge Cases เช่น Idempotency Race Condition, การรั่วไหลของข้อมูลข้าม Tenant/Requester หรือการเกิด Memory Leak จากไฟล์อัปโหลด การมี Acceptance Criteria และการเขียน Automated Test กำกับไว้ล่วงหน้า ทำให้สามารถทดสอบและตีกรอบให้ AI ปรับแก้จนผ่านเกณฑ์ได้อย่างปลอดภัย

2. **คุณค่าของการทำ Peer Review ควบคู่กับ AI:**
   การทำงานร่วมกับเพื่อนร่วมชั้น (@thanapornboont-star) แสดงให้เห็นถึงความสำคัญของ Human Reviewer ตัวอย่างเช่น ใน Issue 3 เพื่อนสามารถมองเห็นจุดบกพร่องเรื่อง Concurrent Requests ที่ใช้ Idempotency-Key เดียวกัน และใน Issue 5 เพื่อนได้ช่วยสังเกตเรื่อง Accessibility (`:focus-visible`) และ Responsive Layout บนมือถือ ซึ่งเป็นจุดที่มักถูกมองข้ามหากพึ่งพา AI เพียงอย่างเดียว
